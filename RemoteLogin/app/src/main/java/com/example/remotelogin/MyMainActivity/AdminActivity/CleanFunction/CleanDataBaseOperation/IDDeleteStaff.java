...
public class IDDeleteStaff extends AsyncTask<String, Void, Void> {
    final private String TAG = "MYTAG";
    private Context context;

    public IDDeleteStaff(Context context) {
    ...
    protected Void doInBackground(String... strings) {
        ...
        if (conn != null) {
            String sql = "delete from info_clean_staff where id=" + strings[0];
            try {
...
//                Toast.makeText(context.getApplicationContext(), "修改密码失败", Toast.LENGTH_LONG).show();
    ...
    protected void onPostExecute(Void unused) {
        ...
        Toast.makeText(context.getApplicationContext(), "删除保洁人员成功", Toast.LENGTH_LONG).show();
    }
}