...
public class ChangeCleanForm extends AsyncTask<String, Void, Void> {
    final private String TAG = "MYTAG";
    private Context context;

    public ChangeCleanForm(Context context) {
...
//                Toast.makeText(context.getApplicationContext(), "修改密码失败", Toast.LENGTH_LONG).show();
    ...
    protected void onPostExecute(Void unused) {
        ...
        Toast.makeText(context.getApplicationContext(), "修改表单成功", Toast.LENGTH_LONG).show();
    }
}
