...
public class IdChangePwd extends AsyncTask<String, Void, Void> {
    final private String TAG = "MYTAG";
    private Context context;

    IdChangePwd(Context context) {
    ...
    protected Void doInBackground(String... strings) {
        ...
        if (conn != null) {
            String sql = "update normal_user set password='" + strings[1] + "' where id = " + strings[0];
...
//                Toast.makeText(context.getApplicationContext(), "修改密码失败", Toast.LENGTH_LONG).show();
    ...
    protected void onPostExecute(Void unused) {
        ...
        Toast.makeText(context.getApplicationContext(), "修改密码成功", Toast.LENGTH_LONG).show();
    }
}